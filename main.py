...
'''Функция выполняет аттаку на противника и выводит в терминал нанесённый урон.'''
...
'''Функция выполняет защиту персонажа и нанесённый урон при нанесении удара.'''
...
'''Выполняет применение особого навыка героя.'''
...
'''Выводит характеристику персонажа, первый игровой (тренировочный) бой.'''
...
'''Предоставляет выбор персонажей (описание каждого героя).'''
